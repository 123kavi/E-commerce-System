...
import com.cylonomic.repository.CartItemRepository;
...
public class ShoppingCartServiceImpl implements ShoppingCartService {
	...
	public CartItem addArticleToShoppingCart(Userinformation userinformation, User user, int qty, String size) {
		ShoppingCart shoppingCart = this.getShoppingCart(user);
		CartItem cartItem = shoppingCart.findCartItemByArticleAndSize(userinformation.getId(), size);
